        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-poppins font-bold text-xl">AppDost</span>
            </div>
            <p className="text-slate-300 leading-relaxed">
              Empowering businesses through innovative digital solutions. 
              We transform ideas into powerful, market-ready applications.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-slate-400 hover:text-white hover:bg-indigo-600 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service, index) => (
                <li key={index}>
                  <span className="text-slate-300 hover:text-white transition-colors duration-300 cursor-pointer flex items-center group">
                    <span className="w-0 group-hover:w-2 h-0.5 bg-sky-400 transition-all duration-300 mr-0 group-hover:mr-2"></span>
                    {service}
                  </span>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">hello@appdost.com</span>
              </div>
            </div>
          </div>
        </div>
